const products = [
    ...
    {
      _id: '7',
      name: 'Laptop Echo Dot 3rd Generation',
      image: '/images/laptop1.jfif',
      description:
        'Laptop Echo Dot - Our most popular smart speaker with a fabric design. It is our most compact smart speaker that fits perfectly into small space',
      brand: 'Amazon',
      category: 'Electronics',
      price: 29.99,
      countInStock: 0,
    ...
    {
      _id: '8',
      name: 'Computer Echo Dot 3rd Generation',
      image: '/images/laptop.jfif',
      description:
        'Computer Echo Dot - Our most popular smart speaker with a fabric design. It is our most compact smart speaker that fits perfectly into small space',
      brand: 'Amazon',
      category: 'Electronics',
      price: 29.99,
      countInStock: 0,
